...
class ShopsRegisterPage extends StatefulWidget {
  const ShopsRegisterPage({super.key});

  @override
  _ShopsRegisterPageState createState() => _ShopsRegisterPageState();
}

class _ShopsRegisterPageState extends State<ShopsRegisterPage> with TickerProviderStateMixin {
  final Map<String, dynamic> userConfig = {
    ...
    'subtitle': 'Setup your online store'
  };
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              // Full Name Field
                              _buildTextField('Owner Name', 'Enter your full name', 
                              ...
                              // Shop Name Field
                              _buildTextField('Shop Name', 'Enter your shop name', 
                                  (value) => shopName = value, Icons.store_outlined),
                              
                              SizedBox(height: isSmallScreen ? 18 : 20),
                              
                              // Shop Address Field
                              _buildTextField('Shop Address', 'Enter your shop address', 
                                  (value) => shopAddress = value, Icons.location_on_outlined),
                              
                              SizedBox(height: isSmallScreen ? 18 : 20),
                              
                              // Business Type Field
                              _buildTextField('Business Type', 'E.g. Electronics, Clothing, etc.', 
                                  (value) => businessType = value, Icons.category_outlined),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text(
                'Your shop is ready to go online. Start adding your products now!',
                style: TextStyle(
                  fontSize: 15,
                  color: Color(0xFF64748B),
                  fontWeight: FontWeight.w500,
  ...
  bool _validateForm() {
    if (fullName.isEmpty || email.isEmpty || password.isEmpty || confirmPassword.isEmpty || 
        phoneNumber.isEmpty || shopName.isEmpty || shopAddress.isEmpty || businessType.isEmpty) {
