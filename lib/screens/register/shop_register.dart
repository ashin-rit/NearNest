...
class _ShopsRegisterPageState extends State<ShopsRegisterPage> with TickerProviderStateMixin {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      // Get the user ID (uid) from the authentication result
      final userId = userCredential.user?.uid;

      if (userId != null) {
        // --- Firestore Data Storage Logic ---
        // Use the userId to create a new document in the 'users' collection
        ...
        await usersCollection.doc(userId).set({
          ...
          'role': userConfig['role'], // Added role field for shop
