...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ServiceProviderLoginPage(),
...
class _ServiceProviderLoginPageState extends State<ServiceProviderLoginPage> with TickerProviderStateMixin {
  final Map<String, dynamic> serviceProviderUser = {
  ...
  @override
  Widget build(BuildContext context) {
    final currentUser = serviceProviderUser;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextField(
                                  key: const ValueKey('email_provider'),
                              ...
                              Container(
                                ...
                                child: TextField(
                                  key: const ValueKey('password_provider'),
  ...
  Future<void> _handleLogin() async {
    ...
    final user = serviceProviderUser;
    ...
    if (email == user['username'] && password == user['password']) {
      ...
      setState(() => error = 'Invalid credentials. Please check your ${serviceProviderUser['inputLabel'].toLowerCase()} and password.');
    }
  }
}