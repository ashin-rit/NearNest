...
class _AdminLoginPageState extends State<AdminLoginPage> with TickerProviderStateMixin {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextField(
                                  key: const ValueKey('email_admin'),
                              ...
                              Container(
                                ...
                                child: TextField(
                                  key: const ValueKey('password_admin'),
  ...
  Future<void> _handleLogin() async {
    ...
    if (email == user['username'] && password == user['password']) {
      ...
      setState(() => error = 'Invalid credentials. Please check your ${adminUser['inputLabel'].toLowerCase()} and password.');
    }
  }
}